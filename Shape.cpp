...
Shape::Shape(size_t m_height, size_t m_width, std::string m_name, char m_pen) 
{
    name = m_name;
    pen = m_pen;
    height = m_height;
...
void Shape::setHeight(const size_t& m_height) { height = m_height; }

void Shape::setWidth(const size_t& m_width) { width = m_width; }
